...
public class IPDPaciente {
     ...
     * @param notificacionPacienteGES Este parametro inidica si el paciente fue
     * notificado
     * @param confirmado Este paramentro indica si el paciente fue confirmado su
     * diagnostico
     * @param descartado Este parametro indica si el paciente fue descartado su
     * diagnostico
     * @param exceptuado Este parametro indica si se le considera exceptuada la
     * atencion al paciente
     * @param observacion Este parametro contiene la observacion del medico que
     * lo examino
     * @param codPatologias Este parametro contiene los codigos de las
     * patologias
    ...
    /**
     * Metodo que retorna un entero que contiene la clave secundaria del
     * paciente
     *
    ...
    /**
     * Este metodo sirve para editar el atributo que almacena el id del
     * registrador
     *
     * @param idRegistrador Este parametro se utiliza para editar el atributo
     * que almacena el id del registrador
     */
     ...
     *
     * @param rutPaciente Este parametro se utiliza para editar el atributo que
     ...
     *
     * @param nombrePaciente Este parametro sirve para editar el atributo que
    ...
    /**
     * Este metodo retorna el atributo que contiene la fecha de ingreso del caso
     * del paciente
     *
     * @return Retorna un valor tipo Date que contiene la fecha de ingreso del
     * caso del paciente
     */
    ...
    /**
     * Este metodo retorna el atributo que contiene el estado de descartado del
     * diagnostico del paciente
     *
     * @return Retorna un valor de tipo boolean que contiene el estado de
     * descartado del diagnostico del paciente
     */
    ...
    /**
     * Este metodo edita el atributo qe contiene la fecha de termino del caso
     * del paciente
     *
     * @param fechaInicio Este parametro sirve para editar el valor de la fecha
     * de termino del caso del paciente
     */
    ...
    /**
     * Este metodo retorna el atributo que contiene la fecha de termino del caso
     * del paciente
     *
     * @return Retorna un valor de tipo Date que contiene la fecha del termino
     * de caso del paciente
     */
    ...
    /**
     * Este metodo edita el atributo que contiene la fecha de termino del caso
     * del paciente
     *
     * @param fechaTermino Este parametro sirve para editar la fecha de termino
     ...
     *
     * @return Retorna un valor de tipo boolean que contiene si el paciente es
     * ges
     */
     ...
     *
     * @param esGes Este parametro sirve para editar el atributo que indica si
     * el paciente es ges
     */
     ...
     *
     * @return Retorna un valor de tipo boolean que indica si el paciente fue
     * notificado
     */
     ...
     *
     * @param notificacionPacienteGES Este parametro sirve para editar el
     * atributo que indica si el paciente fue notificado
     */
    ...
    /**
     * Este metodo retorna el atributo que indica si el diagnostico del paciente
     * esta confirmado
     *
     * @return Retorna un valor de tipo boolean que indica si el diagnostico del
     * paciente esta confirmado
     */
    ...
    /**
     * Este metodo edita el atributo que indica si el diagnostico del paciente
     * esta confirmado
     *
     * @param confirmado Este parametro edita el atributo que indica si el
     * diagnostico del paciente esta confirmado
     */
    ...
    /**
     * Este metodo retorna el atributo que contiene si la atencion del paciente
     * esta exceptuada
     *
     * @return Retorna un valor de tipo boolean que contiene si la atencion de
     * paciente esta exceptuada
     */
    ...
    /**
     * Este metodo edita el atributo que contiene si la atencion del paciente
     * esta exceptuada
     *
     * @param exceptuado Este parametro edita el atributo que contiene si la
     * atencion del paciente esta excpetuada
     */
    ...
    /**
     * Este metodo retorna el atributo que contiene la observacion hecha por el
     * medico que atendio al paciente
     *
     * @return Retorna un valor de tipo String, que contien la observacion hecha
     * por el medico que atendio al paciente
     */
    ...
    /**
     * Este metodo edita el atributo que contiene la observacion hecha por el
     * medico que atendio al paciente
     *
     * @param observacion Este parametro edita el atributo que contiene la
     * observacion hecha por el medico que atendio al paciente
     */
    ...
    /**
     * Este metodo sobre escribe el toString para enviar la informacion del
     * objeto
     *
