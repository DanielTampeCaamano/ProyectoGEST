...
public class HerramientaLogIn implements Herramienta {
    ...
    /**
     * Este metodo se venia con la implementacion de la interfaz Herramienta,
     * intentar usarlo muestra un mensaje de error
     *
     * @param inicio Recibe una variable de tipo Date que hace alucion a la
     * fecha de incio de la atencion del paciente
     * @param termino Recibe una variable de ipo Date que hace alucion a la
     * fecha de termino de la atencion del paciente
    ...
    /**
     * Metodo que venia con la implementacion de la interfaz Herramienta, usarlo
     * muestra un mensaje de error
     *
     * @param nombre Recibe un String que contiene el nombre del paciente
     * @return Retorna un objeto de clase Paciente, en esta implementacion solo
     * se envia un objeto nulo
     */
    @Override
     ...
     * muestra un mensaje de error
     *
     * @param rut Recibe un objeto de clase Rut, objeto que maneja las
     * operaciones que se hacen con un rut del paciente
     * @return Se espera que retorne un objeto de la clase Paciente, sin embargo
     * esta implementacion solo retorna null
     */
    @Override
    ...
    /**
     * Metodo que venia en la implementacion de la interfaz Herramienta, usarlo
     * muestra un mensaje de error
     *
     * @param p Recibe un objeto de clase Persona, haciendo alusion a alguna
     * persona que se pretende verificar
     * @return Debiera retornar si existe la persona o no, sin embargo aqui solo
     * retorna falso, ya que no se pretende usar el metodo desde esta clase
     */
    @Override
    ...
    /**
     * Metodo que viene con la implementacion de Herramienta, aqui se utiliza
     * para buscar una persona en concreto
     *
     * @param rut recibe un obejto de clase Rut, el cual contiene el rut de la
     * persona que se pretende verificar
     ...
     * muestra un mensaje de error
     *
     * @return Se esperaria que retorne una lista de pacientes, sin embargo solo
     * retornara null
     */
    @Override
     ...
     *
     * @param r Recibe un objeto del tipo monitor, que hace al monitor que se
     * pretendia registrar
     */
    @Override
     ...
     * solo muestra un mensaje de error
     *
     * @param r Recibe un objeto de clase Registrador, que hace alucion al
     * registrador que se pretendia registrar
     */
    @Override
    ...
    /**
     * Metodo que venia en la implementacion de la interfaz Herramienta, en este
     * caso no hace nada
     *
     * @param id Recibe un entero, que hace alucion al id del IPD
     * @return Debiera retornar un objeto de clase IPDPaciente, aqui no retorna
     * nada
     */
    @Override
     ...
     * caso no hace nada
     *
     * @return Debiera retornar un arreglo de String, sin embargo aqui no
     * retorna nada
     */
    @Override
    ...
    /**
     * Metodo que venia con la implementacion de la interfaz Herramienta, en
     * este caso no hace nada
     *
     * @param nombre Recibe una variable de tipo String, que hacia alusion al
     ...
     * @return Debiera retornar un objeto de clase Registrador, aqui no retorna
     * nada
     */
    @Override
